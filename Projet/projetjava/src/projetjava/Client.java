...
public class Client {
    ...
    ///How to send command GetTemp to getTemp function ThreadedConnectionHandler.java from the server 
    //public class because I use it in GraphicUserInterface (paint function - display temperature points)1
